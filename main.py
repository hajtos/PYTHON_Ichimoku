...
wykres_4h.register_indicator(ichimoku_senkou_span_A, "senkou_span_A", 7, 28)
wykres_4h.register_indicator(ichimoku_senkou_span_B, "senkou_span_B", 28, 119)
wykres_4h.calculate_all_indicators()
wykres_4h.save_to_file("test.csv")

wykres_24h = Graph()
wykres_24h.load_from_file("USDJPY/Ask_Daily.csv", katalog+"/BID_Daily.csv")
...
ichimoku.traverse_graph('2010-01-01 00:00:00', '2011-01-01 00:00:00')
